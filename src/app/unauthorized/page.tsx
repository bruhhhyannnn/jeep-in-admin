...
export default function UnauthorizedPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-5 bg-gray-950 px-4 dark:bg-gray-100">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-200 dark:text-gray-800">Access Denied</h1>
